...
TEST(gauss_method, can_calculate_big_not_random_matrix_that_was_with_error_1) {
    ...
    std::vector<double> b = { 7, 4, 8, 6, 0, 5, 7, 7, 1, 2 };
    std::vector<double> res(10);
    std::vector<double> vec = { 9,  4,  6,  2,  7,  8,  6,  3,  7,  7,  9,  6,  3,  2,  3,  7,  1,  5,  0,  0,  8,  8,  2,  7,  2,  1,  8,  4,  0,  0,  2,  2,  2,  9,  7,  1,  9,  1,  3,  7,  8,  8,  7,  6,  0,  8,  5,  4,  5,  3,  0,  0,  2,  0,  0,  6,  3,  4,  2,  9,  8,  8,  1,  7,  5,  5,  0,  0,  9,  8,  7,  3,  7,  7,  9,  4,  3,  0,  5,  8,  5,  4,  7,  3,  1,  8,  7,  2,  5,  1,  3,  0,  5,  9,  2,  0,  3,  1,  8,  6 };
    Matrix mat(vec);
    if (rank == 0) {
        res = mat.getSequentialSolution(b);
    }
